...
{
	cout << "\nInside the MyTriangle constructor.\n";
...
void MyTriangle::m_SetSides()  // prompt user to enter a value for the height of the triangle
{
	m_SideA = m_Height;
	m_SideB = m_Base;
	m_SideC = sqrt((m_SideA*m_SideA) + (m_SideB*m_SideB));
/*
...
double MyCircle::m_GetCircum()
{
	return m_Circumference;
}

void MyCircle::m_DisplayData()
{
	system("pause");
	system("cls");
	cout << "\nYour Circle has a radius of " << m_Radius << ".\n";
	cout << "\nYour Circle's area is " << m_GetArea() << ".\n";
	cout << "\nYour Circle's circumference is " << m_GetCircum() << ".\n";
	cout << "\nThat is all the data for your circle.\n\n";
}
